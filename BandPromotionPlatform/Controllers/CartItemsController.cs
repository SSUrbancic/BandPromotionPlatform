...
namespace BandPromotionPlatform.Controllers
{
    public class CartItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CartItemID,CartItemPrice,ProductQuantity,ProductID")] CartItem cartItem)
        {
            ...
            ViewData["ProductID"] = new SelectList(_context.Set<Product>(), "ProductID", "ProductID", cartItem.ProductID);
            return View(cartItem);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CartItemID,CartItemPrice,ProductQuantity,ProductID")] CartItem cartItem)
        {
